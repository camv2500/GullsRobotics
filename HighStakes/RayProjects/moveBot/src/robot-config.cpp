...
Motor back_right_wheels (BACK_RIGHT_PORT, true); 
Motor middle_left_wheels (MIDDLE_LEFT_PORT, true);
...
Motor top_front_right_wheels (TOP_FRONT_RIGHT_PORT, true);
Motor top_front_left_wheels (TOP_FRONT_LEFT_PORT, false);
